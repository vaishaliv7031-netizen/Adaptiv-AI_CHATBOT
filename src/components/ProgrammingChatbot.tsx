...
export default function ProgrammingChatbot() {
  ...
  if (authLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-100 text-slate-800 w-full h-full">
    ...
    return (
      <div className="flex min-h-screen w-full items-center justify-center bg-slate-100 p-4">
        <div className="w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
          {/* Header/Banner */}
          <div className="bg-gradient-to-tr from-slate-900 to-indigo-950 p-8 text-center text-white relative overflow-hidden">
            ...
            <div className="inline-flex p-3.5 bg-white/10 rounded-2xl mb-4 backdrop-blur-md border border-white/10">
              <MessageSquareCode className="w-8 h-8 text-blue-300" />
            </div>
            <h2 className="text-2xl font-extrabold tracking-tight">Query & Programming Agent</h2>
            <p className="text-xs text-indigo-200 mt-2 leading-relaxed">
              Your high-performance companion for code explanation, context-aware debugging, and intelligent refactoring.
            </p>
          </div>
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-4">
              <div className="text-center">
                <span className="text-xs font-bold text-blue-600 uppercase tracking-wider block mb-1">Secure Sign-In Required</span>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Authenticate using your Google account to unlock full multi-session workspaces, historical logging, and adaptive prompt compilation.
                </p>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-5 py-4 bg-slate-900 hover:bg-slate-800 text-white hover:text-white font-bold text-sm rounded-2xl shadow-md transition-all duration-250 transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer border border-slate-800"
              >
            ...
            <div className="border-t border-slate-100 pt-4">
              <div className="flex items-start gap-2 text-[11px] text-slate-500">
                ...
                <span className="leading-normal">
                  All connection sessions run inside high-security tunnels to protect underlying proprietary codebases from unauthorized exposure.
                </span>
              </div>
            </div>
          </div>
